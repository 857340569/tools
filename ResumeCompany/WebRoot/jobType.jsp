...
<link href="./js/myselect/myselect-v.1.0.0.css" rel="stylesheet"
	type="text/css" />
<script src="./js/myselect/myselect-v.1.0.0.js" type="text/javascript"
	language="javascript"></script>
...
<script language="JavaScript">
	var firstTitle = [ "生活服务类", "商务销售类", "技术制造类", "文化教育类", "环保医疗类", "其他职位" ];
	var secondTitle = [
	...
	var contents = [
			...
			$(function(){
				...
				{
					var rowItemHtml="<tr><td class='job_left_td'>"+firstTitle[row]+"</td>"+"<td><ul class='secondRow'>";
				...
				$(".secondRow").each(function(){
					$(this).find(".show_second_title").click(function(){
...
.content_item:hover,.show_second_title:hover {
	background: #d5d5d5;
}
