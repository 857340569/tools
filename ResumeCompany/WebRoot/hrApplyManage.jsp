	...
	function queryCompanies(){
		$.ajax({
			...
			success:function(jsondata)
			{
				...
				{
					comIsPassed=false;
					setError("op_dia_content", "您还没有发布任何企业,请先在<<<企业管理->查看企业>>中发布！");
				}else{
...
<body topmargin="0" leftmargin="0">
	<div>
		<div style="float: left;margin-bottom:10px; ">
			<form class="queryJobs" id="queryJobs" method="post" action="job!queryHrApplyByCondtion" target="secondFrame">
			<input type="hidden" name="company.id" id="com_id" value="-${id}">
			<ul id="query_data_ul">
				...
				<li class="query_data_li">
					<div id="show_secom_name" class='zjp_myselect_currentSelect' style="width:150px;height:30px;margin-left:10px;cursor:pointer;" onclick="showOptionDialog();"><span id="show_com_select_value" class='zjp_myselect_currentSelect_show'>-请选择企业-</span><span class='zjp_myselect_currentSelect_icon'></span></div>
					<div id="data_option_dialog" style="display:none;position:absolute;left:204px;top:43px;z-index: 10000;border:1px solid #9d9d9d;height:240px;width:400px;background:#fff; ">
	...
	<iframe name="secondFrame" id="secondFrame" src="job!queryHrApplyByCondtion?company.id=-${id}" width="100%" height="1000" frameborder="0" scrolling="no"></iframe>
</body>
</html>
