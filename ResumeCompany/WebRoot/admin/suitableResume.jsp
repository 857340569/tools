	...
	function reloadJobDataEvent()
	{
		...
		$(".show_job_content").each(function(){
			$(this).bind("click",function(){
				...
				var infactType=$(this).attr("infactType");
				$("#job_category").val(infactType);
...
// 					alert("您还没有发布任何企业,请先在<<企业管理>>中发布！");
					...
					for(var i=0;i<jsondata.jobs.length;i++)
					{
						...
						if(jobType.indexOf("-") != -1)
						{
							...
							jobTypeShow=jobType.substring(splitIndex+1);
						}
						jobContentHtml+="<li class='show_job_content' id='"+jsondata.jobs[i].id+"' infactType='"+jobType+"'>"+jobTypeShow+"</li>";
					}
					jobContentHtml+="</ul>";
...
<body topmargin="0" leftmargin="0">
	<div>
		<div style="float: left;margin-bottom:10px; ">
			<form class="queryJobs" id="queryJobs" method="post" action="resume!suitableResume" target="secondFrame">
			<input type="hidden" name="job.category" id="job_category">
			<ul id="query_data_ul">
	...
	<iframe name="secondFrame" id="secondFrame" src="resume!suitableResume" width="100%" height="1000" frameborder="0" scrolling="no"></iframe>
</body>
</html>
