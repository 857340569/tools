...
<body topmargin="0" leftmargin="0">
	...
	<input type="hidden" name="type" value="addCom">
	<table width="100%" style="table-layout:fixed;" border="0"
		...
		<tr>
			<td class="lefttd" height="28px"><font class="releaseJob_need">*</font>&nbsp;企业LOGO：</td>
			<td class="centerIpt" id="comLogoTd">
				<div id="imgDiv">
					<img id="comLogoImg" src="./images/no_logo.png" />
				</div>
			...
			<td class="tips"> <div class="Validform_checktip" style="position:relative;left:-120px;">建议上传120px*120px的图片</div></td>
			<td></td>
		</tr>
		<tr>
			...
			<td colspan="2" valign="middle" style="padding-left: 4px;">
				<font id="upd_tips" color="#afafaf" >最多可上传3张图片(建议尺寸480px*240px)，支持jpg/gif/png/jpeg格式</font>
			</td>
		</tr>
		</table>
		<div id="s_udimg">
