...
<body>
	...
	<div id="content">
		<div id="contentLeft">
			...
			<div id="left">
				<div class="menul1">
					<span class="menu1Icon"><img  src="./images/guide_icon_company.png"/></span>
					<span class="menu1Title">企业管理</span>
					<span class="menu1Status"><img/></span>
				</div>
				<ul class="menul2">
					<li>
						<span class="menu2Icon"></span> <span class="menu2Title"><a hideFocus="true"
							href="myInfo!myInfo?type=queryHrInfo" onclick="tips()" target="mainFrame">>&nbsp;查看企业</a>
						</span>
					</li>
					<li>
						<span class="menu2Icon"></span> <span class="menu2Title"><a hideFocus="true"
							href="./admin/hr/hrJobManage.jsp" onclick="tips()" target="mainFrame">>&nbsp;查看职位</a>
						</span>
					</li>
					<li>
						<span class="menu2Icon"></span> <span class="menu2Title"><a hideFocus="true"
							href="job!queryOutlineJobs" onclick="tips()" target="mainFrame">>&nbsp;已下线职位</a>
						</span>
					</li>
					<li><span class="menu2Icon"></span> <span
						class="menu2Title"><a href="./hrApplyManage.jsp"  onclick="tips()" hideFocus="true"
		...
		<div id="contentMain">
			...
			<div id="mainTop">
				<div id="main_top_adminName">欢迎您，<span style="font-size: 25px">${adminName}</span></div>
			</div>
			<div id="mainCenter">
				<span>【<label id="currentItem">查看企业</label>】<a id="gd_deal_url" target="mainFrame" style="display:none;"><img/></a></span>
			</div>
			<div id="main">
				<iframe src="myInfo!myInfo?type=queryHrInfo" scrolling="no" frameborder="0" onload="iFrameSize('mainFrame');" name="mainFrame" id="mainFrame"></iframe>
			</div>
		</div>
	</div>
</body>
