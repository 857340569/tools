;(function($){
    ...
    $.fn.iSimulateSelect=function(iSet){
        iSet=$.extend({
            ...
            width:103,//number类型，模拟select的宽度
        ...
        return this.each(function(){
           ...
           var html='<div class="'+iSet.selectBoxCls+'" style="z-index:'+iSet.zindex+'"><div class="'+iSet.curSCls+'" style="width:234px;margin-left: 1px;">'+$(self).find('option:selected').text()+'</div><dl class="'+iSet.optionCls+'" style="display:none;width:'+iSet.width+'%">';
