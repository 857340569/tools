...
import com.yubso.push.android.AndroidFilecast;
import com.yubso.push.android.AndroidGroupcast;
import com.yubso.push.android.AndroidUnicast;
import com.yubso.push.ios.IOSBroadcast;
import com.yubso.push.ios.IOSCustomizedcast;
import com.yubso.push.ios.IOSFilecast;
import com.yubso.push.ios.IOSGroupcast;
import com.yubso.push.ios.IOSUnicast;
...
//		broadcast.send();
	...
	public void sendAndroidUnicast() throws Exception {
		...
		unicast.setPredefinedKeyValue("device_tokens", "ApXq2TIiVXSK6PmNcGe0ZEeb-D5JXqc3rHkY4YxsvQES");
		unicast.setPredefinedKeyValue("ticker", "Android unicast ticker");
		unicast.setPredefinedKeyValue("title",  "中文的title");
		unicast.setPredefinedKeyValue("text",   "Android unicast text");
		unicast.setPredefinedKeyValue("after_open", "go_app");
		//display_type 
		unicast.setPredefinedKeyValue("display_type", DisplayType.MESSAGE.name().toLowerCase());
		unicast.setPredefinedKeyValue("custom", "自定义消息主要内容");
		// TODO Set 'production_mode' to 'false' if it's a test device. 
		// For how to register a test device, please see the developer doc.
...
//		groupcast.send();
	...
	public void sendAndroidCustomizedcast() throws Exception {
		AndroidCustomizedcast customizedcast = new AndroidCustomizedcast("aliasxxxxxxxx");
