...
public abstract class UmengBasePush {
	protected String appkey = "540ec885fd98c5f683012aaf";
	protected String masterSecret = "xvc3xbspuwljro47yxgmsqylq8cnrg7b";
	...
	public boolean send(PushMessageSendHandler pushMessageSendHandler) throws Exception {
		...
		if(pushMessageSendHandler!=null)
		{
			pushMessageSendHandler.onMessageSended(isSendResult, result.toString());
		}
		return true;
	}
