...
public class AndroidCustomizedcast extends AndroidPush {
	public enum ALIAS_TYPE{
		SINA_WEIBO,BAIDU,KAIXIN,QQ,RENREN,TENCENT_WEIBO,WEIXIN
	}
	public AndroidCustomizedcast(String alias) {
		try {
			this.setPredefinedKeyValue("type", "customizedcast");	
			this.setPredefinedKeyValue("alias", alias);	
			this.setPredefinedKeyValue("alias_type", ALIAS_TYPE.SINA_WEIBO.name());
		} catch (Exception ex) {
			ex.printStackTrace();
			System.exit(1);
		}
